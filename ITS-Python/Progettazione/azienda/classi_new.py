...
class _imp_prog:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        # la stessa coppia di oggetti, indipendentemente dai valori degli attributi dell'associazion(e
    @classmethod
    def add(cls, progetto, impiegato, data)-> None:
        link = _imp_prog(progetto, impiegato, data)
        link.progetto()
